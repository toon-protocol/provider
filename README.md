...
connector route table it expects. A listing's price or resources can be
changed without repricing the leases already running (see
[Changing a listing's price](#changing-a-listings-price)). Eviction is being

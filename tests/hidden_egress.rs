...
use common::harness::{
    config_for, harness_from, hidden_config, listing, spawn, spawn_content, RequestSpec, NOW,
};
...
#[tokio::test]
#[ignore = "needs M4-2 (TOON_Network #39): a hidden provider refuses every spawn until per-lease \
            addresses land; drop this attribute when it merges"]

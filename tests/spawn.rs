...
/// The digest every spawn in this file names: whatever
/// `common::stub_registry` answers a manifest fetch with.
fn digest() -> String {
    common::valid_digest()
}
...
/// image.
async fn harness_with_policy(listings: Vec<Listing>, image_policy: ImagePolicyConfig) -> Harness {
